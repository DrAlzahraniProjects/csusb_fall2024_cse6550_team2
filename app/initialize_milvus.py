...
import json
import nltk
from web_crawler import merge_data_sources
...
def initialize_milvus(data, milvus_uri=MILVUS_URI):
    ...
    model = SentenceTransformer('sentence-transformers/all-MiniLM-L6-v2')  # Use the correct model name
...
def initialize_milvus_insert_data():
    KB = merge_data_sources(CORPUS_SOURCES[0], CORPUS_SOURCES[1])
