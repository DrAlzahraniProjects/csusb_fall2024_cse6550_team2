corpus_source = ["https://www.csusb.edu/cse","https://catalog.csusb.edu/colleges-schools-departments/natural-sciences/computer-science-engineering/"]

from bs4 import BeautifulSoup
import requests
from urllib.parse import urljoin
import re
from constants import ALLOWED_CSE_NAVIGATION_SECTIONS, EXCLUDED_TEXTS, EXCLUDED_URLS,ALLOWED_CATALOG_NAVIGATION_SECTIONS
        ...
        try:
            ...
            for link in nav_links:
                ...
                if link_text in ALLOWED_CSE_NAVIGATION_SECTIONS:  # Only process allowed navigation
                    ...
                    print(f"Allowed navigation link found: {link_text} -> {full_url}")

                    # Recursively scrape allowed navigation links
                    if full_url.startswith(base_url) and full_url not in visited:
                        nested_page_data = scrape_page(full_url, visited)
                        if nested_page_data:
                    ...
                    for p in div.find_all("p"):
                        ...
                        if a_tag:
                            ...
                            if not href.startswith("http"):
                                href = urljoin("https://www.csusb.edu/", href)
...
def scrape_navigation_section(url, section_name, visited=set()):
    ...
    :param visited: Set to track visited links.
    :return: Scraped data from the section.
    """
    try:
        if url in visited:
            return []
        ...
        section_data = {"section": section_name, "url": url, "content": []}
...
def merge_data_sources(data_source_1, data_source_2):
    ...
    print(merged_data[0]," 1 SET")
    return merged_data

data_source_1 = scrape_source_1(corpus_source[0])

data_source_2 = scrape_navigation_section(corpus_source[1],ALLOWED_CATALOG_NAVIGATION_SECTIONS)
